...
private String insertSQL = "INSERT INTO PARTNER(PARTNERID,PARTNERNAME,PARTNERADDRESS,PARTNERCITY,PARTNERSTATE,PARTNERCOUNTRY) VALUES(?,?,?,?,?,?)";
private String updateSQL = "UPDATE PARTNER SET PARTNERNAME=?,PARTNERADDRESS=?,PARTNERCITY=?,PARTNERSTATE=?,PARTNERCOUNTRY=? WHERE PARTNERID=?";
  ...
  try
   {
    ...
    preparedStatement.setInt(6, partner.getPartnerId());
    preparedStatement.executeUpdate();
   }
  catch(Exception exception)
   {

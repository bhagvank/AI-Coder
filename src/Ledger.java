...
private String ledgerCity ;
public String getLedgerCity( ) {
    return ledgerCity;
}

public void setLedgerCity( String ledgerCity ) {
    this.ledgerCity=ledgerCity;
}
...
private String ledgerZipCode ;
public String getLedgerZipCode( ) {
    return ledgerZipCode;
}

public void setLedgerZipCode( String ledgerZipCode ) {
    this.ledgerZipCode=ledgerZipCode;
}

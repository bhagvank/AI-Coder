...
private String positionZipCode ;
public String getPositionZipCode( ) {
    return positionZipCode;
}

public void setPositionZipCode( String positionZipCode ) {
    this.positionZipCode=positionZipCode;
}

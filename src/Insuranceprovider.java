...
private String insuranceproviderZipCode ;
public String getInsuranceproviderZipCode( ) {
    return insuranceproviderZipCode;
}

public void setInsuranceproviderZipCode( String insuranceproviderZipCode ) {
    this.insuranceproviderZipCode=insuranceproviderZipCode;
}

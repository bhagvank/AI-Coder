...
private String estateZipCode ;
public String getEstateZipCode( ) {
    return estateZipCode;
}

public void setEstateZipCode( String estateZipCode ) {
    this.estateZipCode=estateZipCode;
}

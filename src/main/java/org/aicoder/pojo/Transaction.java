...
private String transactionZipCode ;
public String getTransactionZipCode( ) {
    return transactionZipCode;
}

public void setTransactionZipCode( String transactionZipCode ) {
    this.transactionZipCode=transactionZipCode;
}
